  ...
  return (
    <>
     ...
     className='sidebar flex flex-col items-center justify-center text-black'>
        ...
        className='bg fixed top-3 left-1 sm:top-0 sm:left-0 bottom-0 w-[70%] sm:w-[300px] md:w-[350px] lg:w-[400px] xl:w-[450px] bg-white/70 sm:bg-white/80'>
            {/* links */}
            <motion.div 
        ...
        <div className='toggleButton'>
            ...
            className='w-12 h-12 sm:w-14 sm:h-14 rounded-full fixed top-8 right-4 sm:top-6 sm:left-6 bg-red-300 border-none cursor-pointer text-black flex items-center justify-center text-2xl'>
                {open ? <FiX /> : <FiMenu />}
            </button>
        </div>
     </motion.div>
