...
const FondThings = () => {
  return (
    <div className='Fond bg-gradient-to-b from-[#0e0e28] to-[#111132] h-full flex flex-col justify-between gap-20'>
      <motion.div className='textContainer flex-1 self-end flex items-center gap-2'>
      ...
      <motion.div className='titleContainer flex-2 flex flex-col items-center'>
